...
<tileset version="1.10" tiledversion="1.11.0" name="corrupted_wall" tilewidth="16" tileheight="16" tilecount="15" columns="5">
 <image source="../Tiles/corrupted_wall.png" width="80" height="48"/>
 <wangsets>
  <wangset name="Corrupted_wall" type="corner" tile="-1">
