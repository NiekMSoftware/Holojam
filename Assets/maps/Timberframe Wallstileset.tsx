...
<tileset version="1.10" tiledversion="1.11.0" name="Timberframe Wallstileset" tilewidth="16" tileheight="16" tilecount="15" columns="5">
 <image source="../Tiles/Timberframe Wallstileset.png" width="80" height="48"/>
 <wangsets>
  <wangset name="TimerFrame" type="corner" tile="-1">
