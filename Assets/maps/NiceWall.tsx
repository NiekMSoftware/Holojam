...
<tileset version="1.10" tiledversion="1.11.0" name="NiceWall" tilewidth="16" tileheight="16" tilecount="15" columns="5">
 <image source="../Tiles/NiceWall.png" width="80" height="48"/>
 <wangsets>
  <wangset name="Nice_Wall" type="corner" tile="-1">
