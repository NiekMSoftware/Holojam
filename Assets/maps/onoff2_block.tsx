...
<tileset version="1.10" tiledversion="1.11.0" name="On and off tiles blue" tilewidth="16" tileheight="16" tilecount="15" columns="5">
 <image source="../Tiles/On and off tiles purple.png" width="80" height="48"/>
 <tile id="0">
 ...
 <wangsets>
  <wangset name="OnOff2_Block(Purple)" type="corner" tile="-1">
