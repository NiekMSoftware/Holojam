...
<tileset version="1.10" tiledversion="1.11.0" name="Memory world bg tileset" tilewidth="16" tileheight="16" tilecount="15" columns="5">
 <image source="../Tiles/Memory world bg tileset.png" width="80" height="48"/>
 <wangsets>
  <wangset name="memory_bg" type="corner" tile="-1">
