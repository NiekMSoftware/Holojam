...
<tileset version="1.10" tiledversion="1.11.0" name="Memory world tileset" tilewidth="16" tileheight="16" tilecount="15" columns="5">
 <image source="../Tiles/Memory world tileset.png" width="80" height="48"/>
 <tile id="0">
 ...
 <wangsets>
  <wangset name="memory_block" type="corner" tile="-1">
